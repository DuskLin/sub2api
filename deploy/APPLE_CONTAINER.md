...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/dusklin/sub2api-local:latest
...
SUB2API_IMAGE=ghcr.io/dusklin/sub2api-local:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
